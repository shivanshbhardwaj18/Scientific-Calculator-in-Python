...
def fact_clicked():
    try:
        num = int(disp.get())
        if num < 0:
            tkinter.messagebox.showerror("Error", "Factorial is not defined for negative numbers")
        else:
            result = 1
...
pibtn = Button(row1, text="pie", font="Segoe 18", relief=GROOVE, bd=0, command=pi_clicked, fg="white", bg="#333333")
